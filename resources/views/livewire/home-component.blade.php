<div>
    ...
    <hr class="my-8">
    <div class="px-3">
        <div class="flex max-w-4xl p-4 mx-auto border rounded-lg shadow-sm border-gray-50">
            <div class="flex flex-col gap-2 align-baseline">
                ...
                <p class="flex text-sm italic">
                    <svg stroke="currentColor" class="w-5 h-5 mx-2" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="px-4 my-8">
        <div class="flex flex-row max-w-4xl gap-2 mx-auto">
            <button class="px-4 py-2 text-gray-500 border border-gray-100 rounded-md">
            ...
            <select name="" id="" class="w-full px-4 py-2 text-gray-500 border border-gray-100 rounded-md focus:ring-1 focus:ring-lime-300">
    ...
    <div class="px-4 ">
        ...
        <div class="max-w-4xl p-4 mx-auto mt-4 border border-gray-200 rounded-lg ">
            <a href="#" class="no-underline">
                <div class="flex justify-between">
                    ...
                    <div>
                        <img src="https://picsum.photos/seed/picsum/80.webp" alt="imagem" class="rounded-lg">
                    </div>
                </div>
            </a>
        </div>
